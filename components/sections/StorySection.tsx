...
export default function StorySection() {
  ...
  const images = storyImages.length
    ? storyImages.map((item) => ({ src: item.media_url, position: item.object_position || 'left' }))
    : [
        { src: '/hero/TBC288-8c168739-6060-41c1-b5e3-93b0581aa660.jpg', position: 'left' },
        { src: '/hero/TBC140-9c898793-a28e-41bb-a3b2-c0f640100ae9.jpg', position: 'left' },
      ];
    ...
    <section id="story" className="section-pad scroll-mt-20 max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-start">
        <div className="space-y-6">
          ...
          {images[1] && <div className="relative aspect-[16/10] w-full overflow-hidden border border-wedding-brown hidden sm:block">
            <Image
              src={images[1].src}
